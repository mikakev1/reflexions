...
## Cerveau
    ...
    -   Lorsque le cerveau butte sur une information de type emotionelle qu'il ne peut traiter, il stoppe les traitements et initie une nouvelle réalité incorporant l'échec à résoudre, l'information n'étant pas traitée elle reste vivace.
    ...
    -   Lorsqu'un individu subissant l'abandon fuit, il cherche à s'établir ailleurs et logiquement il cherche un substrat materiel compatible avec sa survie.
